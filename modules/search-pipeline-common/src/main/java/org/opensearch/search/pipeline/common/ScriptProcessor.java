...
public final class ScriptProcessor extends AbstractProcessor implements SearchRequestProcessor{
    ...
    private final SearchPipelineScript precompiledSearchScript;
    ...
    ScriptProcessor(
        ...
        String description,
        Script script,
        @Nullable SearchPipelineScript precompiledSearchScript,
    ...
    public SearchRequest processRequest(SearchRequest request) throws Exception {
        ...
        final SearchPipelineScript searchScript;
        if (precompiledSearchScript == null) {
            SearchPipelineScript.Factory factory = scriptService.compile(script, SearchPipelineScript.CONTEXT);
    ...
    public static final class Factory implements Processor.Factory {
        ...
        public ScriptProcessor create(
            ...
            try (
                ...
                SearchPipelineScript searchScript = null;
                try {
                    final SearchPipelineScript.Factory factory = scriptService.compile(script, SearchPipelineScript.CONTEXT);
